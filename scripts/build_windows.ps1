...
param(
    ...
    [string]$PerfharmonyWheel = "D:\code\perfharmony\target\wheels\perfharmony-0.2.1-cp312-cp312-win_amd64.whl",  # perfharmony wheel path
...
& "$VenvPath\Scripts\python.exe" -c "import perfharmony; assert perfharmony.__version__ == '0.2.1'; print('perfharmony import smoke test passed')"
